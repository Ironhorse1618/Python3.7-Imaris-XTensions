    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Analysis23 beta" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_Analysis23_beta(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
import ImarisLib
aImarisId=0
def XT_MJG_Filament_Analysis23_beta(aImarisId):
