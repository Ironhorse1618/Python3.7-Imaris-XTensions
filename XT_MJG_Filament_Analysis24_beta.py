    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Analysis24 beta" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_Analysis24_beta(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
import ImarisLib
aImarisId=0
def XT_MJG_Filament_Analysis24_beta(aImarisId):
    ...
    tk.Checkbutton(window, text='Find Filament-Filament Contacts',
                    variable=var8, onvalue=1, offvalue=0).grid(row=10, column=0, padx=40,sticky=W)

    btn = Button(window, text="Analyze Filament", bg='blue', fg='white', command=Filament_options)
    btn.grid(column=0, row=11, sticky=W, padx=100, pady=5)
    ...
    #############
                ...
                #Measure Current segment distance to all Filament point except the current one not to spines.
                    if xDendriteTypeCurrent==0:
                        ...
                        #     res_list = [Positions[i] for i in Id]
                        #     if len([Positions[i] for i in Id])%2==0:
