    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Sholl Analysis beta2" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_ShollAnalysis2_beta(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
#aImarisId=0
def XT_MJG_Filament_ShollAnalysis2_beta(aImarisId):
