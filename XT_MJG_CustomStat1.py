...
def XT_MJG_CustomStat1(aImarisId):
    ...
    def CustomStat():
        global wCustomStat1a, wCustomStat1b, wCustomStat1Math,Entry_Formula_Value
        global CustomPerimeter, vStatNameCustom
    ...
    def Perimeter():
        global wCustomStat1a, wCustomStat1b, wCustomStat1c
        global wCustomStat1Math,Entry_Formula_Value, CustomPerimeter, vStatNameCustom
        wCustomStat1a.set("Area") # default value
        # wCustomStat1Math.set("formula") # default value
    ...
    # tk.Label(window, text='Calculate Custom Statistic#1').grid(row=2, column=0,)
    # w2 = OptionMenu(window, wCustomStat1Math, "+", "-", "*","/", "formula").grid(row=2, column=0,padx=50,sticky=W)
    ...
    tk.Label(window, text='FORMULA:').grid(row=2,column=0, sticky=W)
    ...
    Create1.grid(row=1, column=0,padx=100
                 ,sticky=W)
    ...
    CreatePerimeter.grid(row=3, column=0,padx=380,sticky=W)
