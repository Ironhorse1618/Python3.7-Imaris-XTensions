    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Analysis17 beta" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_Analysis17_beta(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
import ImarisLib
#aImarisId=0
def XT_MJG_Filament_Analysis17_beta(aImarisId):
        ...
        #ReOrder segment
                ...
                #flattten list
                    if len(vSegmentPositionsWorking)<5:
                        ...
                        # zReOrderedFilamentPositionsWorking.append(vSegmentPositionsWorking)
                        # zReOrderedFilamentRadiusWorking.append(vSegmentRadiusWorking)
