...
#         <Submenu name="Surfaces Functions">
    ...
    #         <Command>Python3XT::XT_MJG_FilamentToSpots3(%i)</Command>
    #       </Item>
         #</Submenu>
#      </Menu>
#      <SurpassTab>
...
import ImarisLib
#aImarisId=0
def XT_MJG_FilamentToSpots3(aImarisId):
    ...
    #Set the ID for dendrite segment
       ...
       #Find current Working Dendrite segment parts
            # vSegmentPositionsWorking=[x[1] for x in enumerate(vFilamentsXYZ)
            #                   if x[0] in vEdgesUniqueWorking]
            # vSegmentRadiusWorking=[x[1] for x in enumerate(vFilamentsRadius)
            #                   if x[0] in vEdgesUniqueWorking]
            # vSegmentTypesWorking=[x[1] for x in enumerate(vTypes)
            #                   if x[0] in vEdgesUniqueWorking]
    ...
    ###############################################################################
            ...
            if len(zIndiv)<3:
                ...
                vAllSegmentsTypesPerFilamentWorkingInserts.extend([0]*len(vSegmentRadiusWorking))
