    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Analysis27 beta" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_Analysis27_beta(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
import ImarisLib
aImarisId=0
def XT_MJG_Filament_Analysis27_beta(aImarisId):
    ...
    try:
        ...
        #For bouton detect and Spots display
                if max(vSegmentTypesWorking)==1 and vOptionFilamentToSpotsFill==1 or vOptionFilamentBoutonDetection==1 or vOptionFilamentCloseToSpots==1 or vOptionIntensity==1 or vOptionDendriteToDendriteContact==1 or vOptionFilamentToFilamentContact==1:
        ###########################
        ###########################
        #ReOrder segment
                #Reordering
        ...
        # Detect VaricositiesBoutons based on the radius of filled spot list
                if vOptionFilamentBoutonDetection==1 and max(vSegmentTypesWorking)==0:
                    ...
                    # # [np.where(prominences>0.25)]
                    # peaks=(peaks[np.array([np.where(prominences>0.25)])]).reshape(-1,1)
