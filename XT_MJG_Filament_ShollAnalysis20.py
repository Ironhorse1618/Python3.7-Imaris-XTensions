    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Sholl Analysis20" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_ShollAnalysis20(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
aImarisId=0
def XT_MJG_Filament_ShollAnalysis20(aImarisId):
