    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Sholl Analysis17" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_ShollAnalysis17(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
aImarisId=0
def XT_MJG_Filament_ShollAnalysis17(aImarisId):
    ...
    # repeating elements.
        ...
        #
        arr = reduce(operator.concat, vFilamentsEdgesDendritesOnly)
