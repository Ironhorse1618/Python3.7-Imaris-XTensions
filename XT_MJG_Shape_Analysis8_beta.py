...
#             <Item name="2D Shape Analysis8 beta" icon="Python3">
#                 <Command>Python3XT::XT_MJG_Shape_Analysis8_beta(%i)</Command>
#             </Item>
#         </Submenu>
#     </Menu>
#     <SurpassTab>
...
aImarisId=0
def XT_MJG_Shape_Analysis8_beta(aImarisId):
