    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Sholl Analysis8" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_ShollAnalysis8(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
aImarisId=0
def XT_MJG_Filament_ShollAnalysis8(aImarisId):
