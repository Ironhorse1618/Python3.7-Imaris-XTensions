    ...
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Analysis37" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_Analysis37(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
import ImarisLib
aImarisId=0
def XT_MJG_Filament_Analysis37(aImarisId):
    ...
    ###############################################################################
            if xCompleteDendriteDendriteContactSpotPositions!=[]:
                ...
                if vBeginningVertex !=-1:
                    ...
                    wSpotBranchPointToAllFilamentDistanceArrayOriginal[wSpotBranchPointToAllFilamentDistanceArrayOriginal==0]=9999
                    ...
                    wSpotBranchPointToAllFilamentDistanceArrayOriginal[:,np.where(wSpotBranchPointToAllFilamentDistanceArrayOriginal==9999)[1].tolist()]=9999
                    ...
                    wSpotToAllFilamentDistanceArrayOriginal[:,np.where(wSpotToAllFilamentDistanceArrayOriginal==9999)[1].tolist()]=9999
                    wSpotToAllFilamentDistanceArrayOriginal[:,np.where(wSpotBranchPointToAllFilamentDistanceArrayOriginal==9999)[1].tolist()]=9999
                    wSpotToAllFilamentDistanceArrayOriginal[:,np.where(wSpotTerminalPointToAllFilamentDistanceArrayOriginal==9999)[1].tolist()]=9999
    ...
    vFilamentStatNames=[' Filament RegularityIndex BranchPoint']*vFilamentCountActual
    vFilaments.AddStatistics(vFilamentStatNames, zAllFilamentsRegularityIndexBP,
                              vFilamentStatUnits, vFilamentStatFactors,
                              vFilamentStatFactorName, vFilamentIds)
    vFilamentStatNames=[' Filament RegularityIndex TerminalPoint']*vFilamentCountActual
