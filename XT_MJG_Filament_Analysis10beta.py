...
#
# July 2020 - Imaris 9.5.1
#
#
    #<CustomTools>
        #<Menu>
            #<Submenu name="Filaments Functions">
                #<Item name="Filament Analysis10 beta" icon="Python3">
                    #<Command>Python3XT::XT_MJG_Filament_Analysis10beta(%i)</Command>
                #</Item>
            #</Submenu>
       #</Menu>
       #<SurpassTab>
...
import ImarisLib
#aImarisId=0
def XT_MJG_Filament_Analysis10beta(aImarisId):
    ...
    # #Remove duplicate segmentIds
        vAllFilamentDendriteLength = [i for n, i in enumerate(vAllFilamentDendriteLength) if i not in vAllFilamentDendriteLength[:n]]
        vAllFilamentDendriteLengthIds = [i for n, i in enumerate(vAllFilamentDendriteLengthIds) if i not in vAllFilamentDendriteLengthIds[:n]]
    ...
    if vOptionSpotsDistanceAlongFilament==1 or vOptionFilamentBoutonDetection==1:
